...
import { ITservicesData } from '../assets/Data';

export default function ElvITservices() {
  return (
    
        <div className='bg-[#F5FFE4] lg:pt-15' >
            {ITservicesData.map((item, index) => {
                ...
                return (
                    <div key={index} className={`   lg:flex items-center  gap-10 xl:gap-10  px-5 md:px-15 xl:px-24 py-10 xl:py-20 ${reverse ? "lg:flex-row-reverse" : ""}`} >
                        <div className='flex-1 w-full'>
                            <img className='w-full  w-190 lg:h-130 ' src={item.image} alt="error" />
                        </div>
